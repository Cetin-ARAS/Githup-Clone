    ...
    <div className={styles.container}>
      ...
      <div>
        <ul className={styles.avatarList}>
          <li>
            {' '}
            <img className={styles.subAvatar} src=" https://avatars.githubusercontent.com/u/101902046?s=40&v=4" alt="avatar" width={24} height={24} />
            Cetin-ARAS/Js.Exercises
          </li>
          <li>
            {' '}
            <img className={styles.subAvatar} src=" https://avatars.githubusercontent.com/u/101902046?s=40&v=4" alt="avatar" width={24} height={24} />
            Cetin-ARAS/react-projects
          </li>
          <li>
            {' '}
            <img className={styles.subAvatar} src=" https://avatars.githubusercontent.com/u/101902046?s=40&v=4" alt="avatar" width={24} height={24} />
            Cetin-ARAS/python-exercises
          </li>
          <li>
            {' '}
            <img className={styles.subAvatar} src=" https://avatars.githubusercontent.com/u/101902046?s=40&v=4" alt="avatar" width={24} height={24} />
          ...
          <li>
            {' '}
            <img className={styles.subAvatar} src=" https://avatars.githubusercontent.com/u/101902046?s=40&v=4" alt="avatar" width={24} height={24} />
            Cetin-ARAS/django-serializers
          </li>
          <li>
            {' '}
            <img className={styles.subAvatar} src=" https://avatars.githubusercontent.com/u/101902046?s=40&v=4" alt="avatar" width={24} height={24} />
            Cetin-ARAS/movie-app
          </li>
          <li>
            {' '}
            <img className={styles.subAvatar} src=" https://avatars.githubusercontent.com/u/101902046?s=40&v=4" alt="avatar" width={4} height={24} />
            Cetin-ARAS/myreact2
          </li>
        ...
        <div className={styles.addition}>
          <img className={styles.avatar} src="https://avatars.githubusercontent.com/t/6398987?s=16&amp;v=4" width="20" height="20" alt="FS-012-TR-Students" />
